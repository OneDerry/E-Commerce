    ...
    <Suspense fallback={<div>Loading...</div>}>
      <div className="min-h-screen">
        ...
        <div className="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-6 py-6">
          <div className="backdrop-blur-sm rounded-3xl shadow p-8 lg:p-12">
              ...
              <div className="lg:col-span-2">
                <div className="mb-8">
                  ...
                  <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6">
                    VDM Gadget Store - Your One-Stop Tech Shop
                  </h1>
                  <div className="flex items-start gap-6 mb-8">
                    ...
                    <div className="pt-4">
                      <p className="text-foreground/80 text-lg leading-relaxed">
                        Discover the latest gadgets and electronics at VDM
                        Store. Quality products at affordable prices with fast
                        delivery.
                      </p>
                    </div>
                  </div>
                  {/* <Link href="/products">
                  <Button className="bg-gradient-to-r from-accent to-primary hover:from-accent/90 hover:to-primary/90 text-white font-semibold px-8 py-4 rounded-2xl text-lg shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse-glow">
                    View All Products
                ...
                <div className="relative mb-8">
                  <div className="relative w-full h-96 lg:h-[500px] rounded-3xl overflow-hidden bg-gradient-to-br from-accent/10 to-primary/10">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative">
                        ...
                        <div className="w-80 h-80 bg-gradient-to-br from-accent to-primary rounded-3xl shadow-2xl flex items-center justify-center transform rotate-12 hover:rotate-6 transition-transform duration-500 animate-float">
                  ...
                  <div className="absolute bottom-6 left-6 flex gap-2">
                    <button className="w-12 h-12 bg-card/80 backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg hover:bg-card transition-colors">
              ...
              <div className="space-y-6">
                ...
                <Card className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 border-0">
                  ...
                  <div className="flex gap-3">
                    <div className="w-24 h-24 bg-gray-300 p-2 rounded-xl border-2 border-white shadow-lg">
                      <Image
